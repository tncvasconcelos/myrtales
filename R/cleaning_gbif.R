...
cleaned_gbif <- FilterWCVP(gbif_data, all_vars, reference_table, path="/Users/thaisvasconcelos/Desktop/WCVP_special_issue/WCVPtools/wgsrpd-master/level3/level3.shp") # This will filter the GBIF points acording to WCVP
